...
#index.padding.column.padding-xl.box.margin-l
	...
	#about v-else=""
		...
		h3
			...
			|  unique URLs stored
		p Update 2022-11-11: Server online again, sorry for the downtime
		...
		p I made a custom export of the entire database as a tsv file (tab-separated values, that is: url and site title). It is unfortunately split into two files, but at least each one of those two is internally sorted by url. They are 285&nbsp;/&nbsp;68&nbsp;GB in size in total (53&nbsp;/&nbsp;14&nbsp;GB compressed) and you can download them both <a href="https://api.link-archive.org/db/dump.sorted.1.tsv.gz">here</a> and <a href="https://api.link-archive.org/db/dump.sorted.2.tsv.gz">here</a>. Please be so decent to cite both link-archive.org and CommonCrawl when you use this data to make any tool or publication.
